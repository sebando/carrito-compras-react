...
export const CartProvider = ({ children }) => {
    ...
    const [shopingList, dispatch] = useReducer(cartReducer, initialState)
    ...
    return (
        <CartContext.Provider value={{ shopingList, addProduct, removeProduct, incrementQuantity, decrementQuantity }}>
            {children}
